...
function Page() {
    ...
    const handleFile = (e) =>{
        ...
        if(!selectedFile){
            const fileError = {file: 'No selected file'}
        ...
        if (!allowedTypes.includes(selectedFile)){
            const fileError = {file: 'Only PDF files are supported'}
            setError({...error, fileError})
            ...
            <div className='bg-gray-300 w-full h-full p-5'>
                ...
                className="max-w-md mx-auto bg-white shadow-md rounded-lg mt-10 p-8">
                    ...
                    <div className="mb-5">
                        <label htmlFor="cv" 
                        className="block mb-2 text-sm 
                        font-medium text-gray-900 dark:text-white">CV/Resume</label>
                        <input type="file" 
                        id="cv"
                        ...
                        focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 
                        dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cv" 
                        required />
                    </div>
                    ...
                    <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                            ...
                            placeholder="Write your cover letter..." required ></textarea>
                        </div>
                    </div>
                    ...
                    <div className='flex place-content-center self-center'>
                        ...
                        text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 cursor-pointer
